...
<div class="container">
    <h1 class="mt-3 py-3">All Tags</h1>
        ...
        <div class="col pe-5 pt-5">
            <form action="" method="post" class="d-flex align-items-center mt-5">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="name" class="form-control" placeholder="Nome nuovo tag" aria-label="Nome nuovo tag" aria-describedby="button-addon2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger m-1 text-white" data-bs-toggle="modal" data-bs-target="#delete-tag-{{$tag->id}}">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="delete-tag-{{$tag->id}}" tabindex="-1" role="dialog" aria-labelledby="modelTitle-{{$tag->id}}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Sei sicuro di voler eliminare questa tag?
                                        </div>
